...
<!-- Please read https://github.com/stealthgyro/docker-headphones/blob/master/.github/CONTRIBUTING.md -->
...
# [linuxserver/headphones](https://github.com/stealthgyro/docker-headphones)
...
[![GitHub Stars](https://img.shields.io/github/stars/stealthgyro/docker-headphones.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/stealthgyro/docker-headphones)
[![GitHub Release](https://img.shields.io/github/release/stealthgyro/docker-headphones.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/stealthgyro/docker-headphones/releases)
[![GitHub Package Repository](https://img.shields.io/static/v1.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=linuxserver.io&message=GitHub%20Package&logo=github)](https://github.com/stealthgyro/docker-headphones/packages)
...
Simply pulling `ghcr.io/stealthgyro/docker-headphones:latest` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  headphones:
    image: ghcr.io/stealthgyro/docker-headphones:latest
...
docker run -d \
  ...
  --restart unless-stopped \
  ghcr.io/stealthgyro/docker-headphones:latest
```
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' ghcr.io/stealthgyro/docker-headphones:latest
    ```
...
* Update the image:
    ...
    ```bash
    docker pull ghcr.io/stealthgyro/docker-headphones:latest
    ```
...
```bash
git clone https://github.com/stealthgyro/docker-headphones.git
cd docker-headphones
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/stealthgyro/docker-headphones:latest .
```
